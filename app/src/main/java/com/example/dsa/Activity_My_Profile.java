...
public class Activity_My_Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleTextView = findViewById(R.id.profileTitleText);
        editProfileImage = findViewById(R.id.profileEditImage);
        editProfileImage.setImageResource(R.drawable.pencil_edit);
        usernameText = findViewById(R.id.profileUsernameText);
        usernameOut = findViewById(R.id.profileUsernameOut);
        usernameEdit = findViewById(R.id.profileEditUsernameOut);
        nameText = findViewById(R.id.profileNameText);
        nameOut = findViewById(R.id.profileNameOut);
        nameEdit = findViewById(R.id.profileEditNameOut);
        mailText = findViewById(R.id.profileMailText);
        mailOut = findViewById(R.id.profileMailOut);
        mailEdit = findViewById(R.id.profileEditMailOut);
        moneyText = findViewById(R.id.profileMoneyText);
        moneyOut = findViewById(R.id.profileMoneyOut);
        editPasswordOld = findViewById(R.id.profileEditPasswordOld);
        editPasswordNew1 = findViewById(R.id.profileEditPasswordNew1);
        editPasswordNew2 = findViewById(R.id.profileEditPasswordNew2);
        deleteBtn = findViewById(R.id.profileDeleteBtn);
        deleteBtn.setText("Delete account");
        returnBtn = findViewById(R.id.profileReturnBtn);
        returnBtn.setText("Return");
        progressBar = findViewById(R.id.profileProgressBar);
        loadingTextView = findViewById(R.id.profileLoadingText);
